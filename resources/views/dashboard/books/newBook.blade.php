    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{route('user.book.save')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-floating mb-3 mb-md-0">

                                <input type="text" class="form-control" name="title" id="bookName" placeholder="Book Title">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-floating mb-3 mb-md-0">
                                ...
                                <input type="text" class="form-control" name="revisionNumber" id="revisionNumber" placeholder="Revision Number">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3 mb-md-0">
                                ...
                                <input type="date" name="publishedDate" class="form-control" id="published_date" placeholder="Published Date">
